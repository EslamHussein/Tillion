...
public class PayFortPayment {
    ...
    //Statics
    private final static String MERCHANT_IDENTIFIER = "QiwPPHJt";
    private final static String ACCESS_CODE = "829AvmYEzso4mhpu1kN2";
    private final static String SHA_TYPE = "SHA-256";
    private final static String SHA_REQUEST_PHRASE = "asfagtryhtrh";
